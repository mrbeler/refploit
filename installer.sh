...
echo $yellow"====================================================================="
echo $cyan "[*]$cyan##############################################################$cyan[*]"
echo $cyan" |*|  $yellow        Author   : Andaacok                               $cyan|*|"
...
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 2.Install MBF buat hek fb cok                            $cyan  [+]"
echo $cyan "[+]============================================================[+]"
...
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 24.Install WIFIHACKER (kuduRoot)                         $cyan  [+]"
echo $cyan "[+]============================================================[+]"
...
echo $cyan "[+]============================================================[+]"
echo $cyan "[+}$yellow 31.Install B4j1N64Nv4                                    $cyan  [+]"                                   
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 32.Intsall Virus (bahaya cok)                            $cyan  [+]"
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 33.Install Razer                                         $cyan  [+]"                                        
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 34.Install Asik-Ae (buat deface)                         $cyan  [+]"
echo $cyan "[+]============================================================[+]"
...
clear
figlet "keluar"
echo $white "Terimakasih bye2 see you next time"
exit
fi
...
pip2 install lolcat
apt install toilet
git clone https://github.com/DarknessCyber/B4j1N64Nv4
cd B4j1N64Nv4
sh bajingan.sh
fi
...
clear
figlet "Menginstall"
git clone https://github.com/MinhasKamal/CuteVirusCollection
bash zip_bomb_42.zip
fi
...
figlet "Menginstall"
pkg install git
git clone https://github.com/PhobiaXploit/Razer
chmod +x razer.sh
./razer.sh
fi
...
figlet "Menginstall"
pkg install git
git clone https://github.com/PhobiaXploit/Asik-Ae
cd Asik-Ae
chmod =x asik-ae.sh
./asik-ae.sh
fi
...
clear
sleep 1
echo $cyan "Tools kecil ini buat install tools lain yh"
sleep 1
echo $cyan "Kalo ada yg rusak tetep keep smile :) hubugin ae nomer gw = 0895336892802"
sleep 1
echo $cyan "My Team : Phobia}{Ploit"
sleep 1
echo $cyan "and all pemogramer indonesia"
sleep 1
echo $yellow "Balik lgi ke  tools dalam 3 detik"
sleep 2
clear
echo $yellow "1"
sleep 1
